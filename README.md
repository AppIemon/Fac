...
| `smoothstone_factory` | 매끄러운 돌 공장 (돌 생성기 + 드로퍼 화로, 제련 1단) | 채굴만 수동 |
| `cobble_factory` | 매끄러운 돌 공장 (조약돌 팜 + 2단 제련 + 자연 켈프) | 채굴 + 건조 연료만 수동 |
...
| `full_factory` | **통합 공장** — TNT 조약돌 + 2단 제련 + 켈프 연료 + 이끼 뼛가루 자급 | TNT 생성기만 별도 |
